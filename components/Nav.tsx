    ...
    <div className="absolute left-0 top-0 flex flex-col w-14 pl-[2.5px] pr-1 h-full bg-base-300 z-40 justify-between">
      <nav className="mt-1 flex">
        <div className="dropdown dropdown-right">
          ...
          <div
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 z-[99] p-2 shadow bg-base-300 rounded-md w-48 gap-2 translate-x-5"
          >
            <Link className="btn hover:btn-primary" href="/web/settings">
              Settings
            </Link>
            <SignOutButton />
          </div>
